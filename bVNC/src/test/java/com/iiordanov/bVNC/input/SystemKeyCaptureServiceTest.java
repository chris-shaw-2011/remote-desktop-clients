...
public class SystemKeyCaptureServiceTest {
    ...
    @Test
    public void identifiesOnlyTheTargetPackage() {
        assertTrue(SystemKeyCaptureService.isTargetPackage(
                "com.iiordanov.aRDP", "com.iiordanov.aRDP"));
        assertFalse(SystemKeyCaptureService.isTargetPackage(
                "com.iiordanov.aRDP", "com.oculus.vrshell"));
        assertFalse(SystemKeyCaptureService.isTargetPackage("com.iiordanov.aRDP", null));
    }
}
