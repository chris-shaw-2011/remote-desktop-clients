...
Status: held-key repeat repair in progress on August 31, 2026. The earlier
lock/modifier revision passed local validation; the combined keyboard changes
still need final physical Quest validation.
